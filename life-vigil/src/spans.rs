...
pub fn chat_span(
    ...
    let span = tracing::info_span!(
        ...
        { semconv::VIGIL_LLM_RETRY_COUNT } = tracing::field::Empty,
        { semconv::VIGIL_LLM_FALLBACK_TRIGGERED } = tracing::field::Empty,
        { semconv::VIGIL_LLM_FALLBACK_REASON } = tracing::field::Empty,
        { semconv::VIGIL_LLM_CIRCUIT_STATE } = tracing::field::Empty,
        { semconv::VIGIL_LLM_FINISH_REASON } = tracing::field::Empty,
